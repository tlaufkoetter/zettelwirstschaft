...
namespace ZettelWirtschaft.Application.Test.Zettel
{
    public class GetZettelDetailTests
    {
        public static IEnumerable<object[]> data = new object[][] {
            new object[] {new ZettelId("theid"), new ZettelEntity(new ZettelId("theid"), new Application.ValueObject.Title("the title"), new ZettelContent("the content"))},
            new object[] {new ZettelId("theid1"),new ZettelEntity(new ZettelId("theid1"), new Application.ValueObject.Title("the title2"), new ZettelContent("the content3"))}
        };
